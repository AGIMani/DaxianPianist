...
# V2 comparison vs run_daxian_v2.sh: same forearm (tx/ty/tz/yaw) and unlocked
# fingers (pinky_rota still pinned at 0). Separate eval folder.
# lookahead 20 = 1.0s buffer / 0.05s dt so the first note is visible at t=0.
EVAL_DIR="${SCRIPT_DIR}/../eval_daxian_v2_unlock_ty"
